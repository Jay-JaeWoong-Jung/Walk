...
public class MemberVO {
	...
	// update용 생성자
	// public MemberVO(String userPass, String phone1, String phone2, String phone3,
	// String emailId, String emailAdd,
	// String company, int selectedTime, String userId, String emailAccept, String
	// profile) {
	// super();
	// this.userPass = userPass;
	// this.phone1 = phone1;
	...
	// login 용 생성자
	public MemberVO(String userId, String userName, String phone1, String phone2, String phone3, int gender,
			String emailId, String emailAdd, String birth, String company, int selectedTime, String emailAccept,
			String profile) {
		super();
		this.userId = userId;
		this.userName = userName;

...
<%@ include file="./navbar.jsp"%> 
	...
	<form action="DispatcherServlet?command=sendPass" method="post" name="mailSenderForm" id="mailSenderForm">
		<div class="container-fluid">
			<label>이름</label><input type="text" name="userName" value="${userName}">
			<div class="col-sm-10">
				<label>이메일</label> <input type="text" name="emailId"
					id="InputEmailId" aria-describedby="emailHelp" value="${emailId }"> <span
			...
			<button type="submit" class="btn btn-primary" value="sendEmail">임시 비밀번호 받기</button>
		</div>
	</form>
